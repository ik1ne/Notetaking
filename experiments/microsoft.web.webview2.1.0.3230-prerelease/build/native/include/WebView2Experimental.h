...
#ifndef __ICoreWebView2ExperimentalControllerOptions3_FWD_DEFINED__
#define __ICoreWebView2ExperimentalControllerOptions3_FWD_DEFINED__
typedef interface ICoreWebView2ExperimentalControllerOptions3 ICoreWebView2ExperimentalControllerOptions3;

#endif 	/* __ICoreWebView2ExperimentalControllerOptions3_FWD_DEFINED__ */
...
#ifndef __ICoreWebView2ExperimentalControllerOptions3_INTERFACE_DEFINED__
#define __ICoreWebView2ExperimentalControllerOptions3_INTERFACE_DEFINED__

/* interface ICoreWebView2ExperimentalControllerOptions3 */
/* [unique][object][uuid] */ 


EXTERN_C __declspec(selectany) const IID IID_ICoreWebView2ExperimentalControllerOptions3 = {0xdf9cb70b,0x8d87,0x5bca,{0xae,0x4b,0x6f,0x23,0x28,0x5e,0x8d,0x94}};

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("df9cb70b-8d87-5bca-ae4b-6f23285e8d94")
    ICoreWebView2ExperimentalControllerOptions3 : public IUnknown
    {
    public:
    ...
    typedef struct ICoreWebView2ExperimentalControllerOptions3Vtbl
    {
        BEGIN_INTERFACE
        
        DECLSPEC_XFGVIRT(IUnknown, QueryInterface)
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ICoreWebView2ExperimentalControllerOptions3 * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        DECLSPEC_XFGVIRT(ICoreWebView2ExperimentalControllerOptions3, get_DefaultBackgroundColor)
        /* [propget] */ HRESULT ( STDMETHODCALLTYPE *get_DefaultBackgroundColor )( 
            ICoreWebView2ExperimentalControllerOptions3 * This,
            /* [retval][out] */ COREWEBVIEW2_COLOR *value);
        
        DECLSPEC_XFGVIRT(ICoreWebView2ExperimentalControllerOptions3, put_DefaultBackgroundColor)
        /* [propput] */ HRESULT ( STDMETHODCALLTYPE *put_DefaultBackgroundColor )( 
            ICoreWebView2ExperimentalControllerOptions3 * This,
            /* [in] */ COREWEBVIEW2_COLOR value);
        
        END_INTERFACE
    } ICoreWebView2ExperimentalControllerOptions3Vtbl;

    interface ICoreWebView2ExperimentalControllerOptions3
    {
        CONST_VTBL struct ICoreWebView2ExperimentalControllerOptions3Vtbl *lpVtbl;
    };
...
#define ICoreWebView2ExperimentalControllerOptions3_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICoreWebView2ExperimentalControllerOptions3_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICoreWebView2ExperimentalControllerOptions3_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ICoreWebView2ExperimentalControllerOptions3_get_DefaultBackgroundColor(This,value)	\
    ( (This)->lpVtbl -> get_DefaultBackgroundColor(This,value) ) 

#define ICoreWebView2ExperimentalControllerOptions3_put_DefaultBackgroundColor(This,value)	\
...
#endif 	/* __ICoreWebView2ExperimentalControllerOptions3_INTERFACE_DEFINED__ */
